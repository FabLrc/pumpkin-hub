...
import { ConfigPluginList } from "@/components/server-builder/ConfigPluginList";
import { PluginPicker } from "@/components/server-builder/PluginPicker";
...
export default function ServerBuilderPage() {
  ...
  function renderServerBuilderBody() {
