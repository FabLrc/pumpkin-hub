  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-24 md:py-32">
        <div className="font-mono text-[11px] text-accent tracking-widest uppercase mb-8">
          {"// from raw performance  →  to a complete ecosystem"}
        </div>
        <h2 className="font-raleway font-black leading-[0.92] tracking-tight text-text-primary text-5xl md:text-7xl lg:text-8xl">
          <span className="block">Five milliseconds.</span>
          <span className="block">One hundred <span className="text-accent">megabytes</span>.</span>
          <span className="block">One <span className="text-accent">registry</span>.</span>
        </h2>
        <div className="mt-10 flex items-center gap-3 font-mono text-[11px] text-text-dim tracking-widest uppercase">
