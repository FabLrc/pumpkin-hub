    ...
    <div className="border border-border-default bg-bg-elevated/30 p-3 flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-3 min-w-0">
        <div className="w-8 h-8 border border-border-hover flex items-center justify-center flex-shrink-0">
          <PlatformIcon platform={binary.platform} />
        </div>
...
function PlatformIcon({ platform }: { platform: string }) {
  switch (platform) {
    case "windows":
      return (
        <svg viewBox="0 0 640 640" className="w-4 h-4 fill-text-dim" aria-label="Windows">
    ...
    case "macos":
      return (
        <svg viewBox="0 0 640 640" className="w-4 h-4 fill-text-dim" aria-label="macOS">
    ...
    case "linux":
      return (
        <svg viewBox="0 0 640 640" className="w-4 h-4 fill-text-dim" aria-label="Linux">
